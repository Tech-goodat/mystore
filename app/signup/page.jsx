  ...
  return (
    <div className='flex flex-col lg:grid text-[#131524] lg:grid-cols-3 md:w-full  h-screen items-center'>
          ...
          <div className='flex items-center justify-center col-span-2 flex-col h-full'>
            ...
            <input type='text' name='name' placeholder='Enter your full name ... ' className='text-[10px] p-4  w-[350px] md:w-[400px] rounded-md outline-none shadow-sm' />
              ...
              <button className='flex cursor-pointer text-[10px] p-4 rounded-full w-[350px] md:w-[400px] items-center justify-center text-white bg-[#FA7275] mt-6 shadow-sm'>Create Account</button>
            </form>
